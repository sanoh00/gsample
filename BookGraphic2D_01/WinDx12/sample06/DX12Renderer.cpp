...
#endif
#if FILTER_LINERAR
		desc_sampler.Filter = D3D12_FILTER_MIN_MAG_MIP_LINEAR;
#endif
#if CLAMP_WRAP
...
#endif
#if CLAMP_MIRROR
		desc_sampler.AddressU = D3D12_TEXTURE_ADDRESS_MODE_MIRROR;
		desc_sampler.AddressV = D3D12_TEXTURE_ADDRESS_MODE_MIRROR;
		desc_sampler.AddressW = D3D12_TEXTURE_ADDRESS_MODE_MIRROR;
#endif
#if CLAMP_CLAMP
		desc_sampler.AddressU = D3D12_TEXTURE_ADDRESS_MODE_CLAMP;
		desc_sampler.AddressV = D3D12_TEXTURE_ADDRESS_MODE_CLAMP;
		desc_sampler.AddressW = D3D12_TEXTURE_ADDRESS_MODE_CLAMP;
#endif
#if CLAMP_BORDER
		desc_sampler.AddressU = D3D12_TEXTURE_ADDRESS_MODE_BORDER;
		desc_sampler.AddressV = D3D12_TEXTURE_ADDRESS_MODE_BORDER;
		desc_sampler.AddressW = D3D12_TEXTURE_ADDRESS_MODE_BORDER;
#endif
#if CLAMP_MIRROR_ONCE
		desc_sampler.AddressU = D3D12_TEXTURE_ADDRESS_MODE_MIRROR_ONCE;
		desc_sampler.AddressV = D3D12_TEXTURE_ADDRESS_MODE_MIRROR_ONCE;
		desc_sampler.AddressW = D3D12_TEXTURE_ADDRESS_MODE_MIRROR_ONCE;
#endif
