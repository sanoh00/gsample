...
#define	PRIMITIVE_POINT_LIST 0
#define	PRIMITIVE_LINE_LIST 0
#define	PRIMITIVE_LINE_STRIP 0
#define	PRIMITIVE_TRIANGLE_LIST	1
#define	PRIMITIVE_TRIANGLE_STRIP	0
